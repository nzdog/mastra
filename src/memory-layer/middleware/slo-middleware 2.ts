...
export function sloMiddleware(req: Request, res: Response, next: NextFunction): void {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Express interop: res.end has variable arguments
  res.end = function (this: Response, ...args: any[]): Response {
    ...
    // Call original end
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Express interop: forwarding variable arguments to original method
