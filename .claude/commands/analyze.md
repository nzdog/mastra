...
- Source size (excluding deps): !`du -sh $(find . -type d -maxdepth 1 ! -name node_modules ! -name .git ! -name dist ! -name build ! -name . 2>/dev/null) 2>/dev/null | awk '{sum+=$1} END {print sum "K"}'`
